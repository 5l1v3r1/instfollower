...
import android.support.p000v4.util.C1353LongSparseArray;
...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private final C1353LongSparseArray<LinearGradient> linearGradientCache;
    ...
    private final C1353LongSparseArray<RadialGradient> radialGradientCache;
    ...
    public GradientFillContent(LottieDrawable lottieDrawable2, BaseLayer baseLayer, GradientFill gradientFill) {
        C1353LongSparseArray<LinearGradient> longSparseArray;
        C1353LongSparseArray<RadialGradient> longSparseArray2;
        Matrix matrix;
        Path path2;
        Paint paint2;
        RectF rectF;
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        ...
        int parentAlpha = i;
        if (!this.hidden) {
            C1265L.beginSection("GradientFillContent#draw");
            this.path.reset();
            ...
            float endSection = C1265L.endSection("GradientFillContent#draw");
        }
    }
