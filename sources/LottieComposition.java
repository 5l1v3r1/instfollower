...
import android.support.p000v4.util.C1357SparseArrayCompat;
...
public class LottieComposition {
    private Rect bounds;
    private C1357SparseArrayCompat<FontCharacter> characters;
    ...
    public void init(Rect bounds2, float startFrame2, float endFrame2, float frameRate2, List<Layer> layers2, LongSparseArray<Layer> layerMap2, Map<String, List<Layer>> precomps2, Map<String, LottieImageAsset> images2, C1357SparseArrayCompat<FontCharacter> characters2, Map<String, Font> fonts2, List<Marker> markers2) {
        this.bounds = bounds2;
    ...
    public C1357SparseArrayCompat<FontCharacter> getCharacters() {
    ...
    public static class Factory {
        ...
        @java.lang.Deprecated
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static com.airbnb.lottie.Cancellable fromRawFile(android.content.Context r9, @android.support.annotation.RawRes int r10, com.airbnb.lottie.OnCompositionLoadedListener r11) {
            /*
                r0 = r9
                r1 = r10
                r2 = r11
        ...
        private static final class ListenerAdapter implements LottieListener<LottieComposition>, Cancellable {
            ...
            /* synthetic */ ListenerAdapter(OnCompositionLoadedListener x0, C12711 r7) {
                this(x0);
                C12711 r2 = r7;
            }
