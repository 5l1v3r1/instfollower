...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        this.isDirty = false;
        C1265L.beginSection("Drawable#draw");
        if (this.compositionLayer != null) {
            ...
            float endSection = C1265L.endSection("Drawable#draw");
            if (saveCount > 0) {
    ...
    public void setMaxProgress(@FloatRange(from = 0.0d, mo103to = 1.0d) float f) {
        Object obj;
        float maxProgress = f;
        if (this.composition == null) {
    ...
    public void setMinAndMaxProgress(@FloatRange(from = 0.0d, mo103to = 1.0d) float f, @FloatRange(from = 0.0d, mo103to = 1.0d) float f2) {
        Object obj;
        float minProgress = f;
