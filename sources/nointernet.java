...
/* renamed from: io.kodular.themysteryman8308.MagicLiker.nointernet */
/* compiled from: nointernet.yail */
public class nointernet extends Form implements Runnable {
    ...
    static final IntNum Lit27 = IntNum.make(-1060);
    static final SimpleSymbol Lit28;
    static final IntNum Lit29 = IntNum.make(-1090);
    static final SimpleSymbol Lit3;
    static final SimpleSymbol Lit30;
    static final FString Lit31;
    static final FString Lit32;
    static final SimpleSymbol Lit33;
    static final IntNum Lit34 = IntNum.make(-1005);
    ...
    static final IntNum Lit40 = IntNum.make(20);
    static final SimpleSymbol Lit41;
    static final FString Lit42;
    static final FString Lit43;
    static final SimpleSymbol Lit44;
    static final IntNum Lit45 = IntNum.make(-1090);
    ...
    static final IntNum Lit59 = IntNum.make(14);
    ...
    public static nointernet nointernet;
    ...
    public Label Label2;
    public Label Label3;
    public final ModuleMethod Label3$Click;
    public KodularLottie Lottie1;
    public Network Network1;
    public final ModuleMethod Network1$OnConnect;
    ...
    public final ModuleMethod nointernet$BackPressed;
    ...
    static {
        ...
        Lit89 = (SimpleSymbol) simpleSymbol.readResolve();
        new SimpleSymbol("dispatchGenericEvent");
        Lit88 = (SimpleSymbol) simpleSymbol2.readResolve();
        new SimpleSymbol("dispatchEvent");
        Lit87 = (SimpleSymbol) simpleSymbol3.readResolve();
        new SimpleSymbol("send-error");
        Lit86 = (SimpleSymbol) simpleSymbol4.readResolve();
        new SimpleSymbol("add-to-form-do-after-creation");
        Lit85 = (SimpleSymbol) simpleSymbol5.readResolve();
        new SimpleSymbol("add-to-global-vars");
        Lit84 = (SimpleSymbol) simpleSymbol6.readResolve();
        new SimpleSymbol("add-to-components");
        Lit83 = (SimpleSymbol) simpleSymbol7.readResolve();
        new SimpleSymbol("add-to-events");
        Lit82 = (SimpleSymbol) simpleSymbol8.readResolve();
        new SimpleSymbol("add-to-global-var-environment");
        Lit81 = (SimpleSymbol) simpleSymbol9.readResolve();
        new SimpleSymbol("is-bound-in-form-environment");
        Lit80 = (SimpleSymbol) simpleSymbol10.readResolve();
        new SimpleSymbol("lookup-in-form-environment");
        Lit79 = (SimpleSymbol) simpleSymbol11.readResolve();
        new SimpleSymbol("add-to-form-environment");
        Lit78 = (SimpleSymbol) simpleSymbol12.readResolve();
        new SimpleSymbol("android-log-form");
        Lit77 = (SimpleSymbol) simpleSymbol13.readResolve();
        new SimpleSymbol("get-simple-name");
        Lit76 = (SimpleSymbol) simpleSymbol14.readResolve();
        new SimpleSymbol("OnConnect");
        Lit75 = (SimpleSymbol) simpleSymbol15.readResolve();
        new SimpleSymbol("Network1$OnConnect");
        Lit74 = (SimpleSymbol) simpleSymbol16.readResolve();
        new SimpleSymbol(PropertyTypeConstants.PROPERTY_TYPE_TEXT);
        SimpleSymbol simpleSymbol59 = (SimpleSymbol) simpleSymbol17.readResolve();
        Lit9 = simpleSymbol59;
        Lit73 = PairWithPosition.make(simpleSymbol59, LList.Empty, "/tmp/1598816816957_0.3832455549052588-0/youngandroidproject/../src/io/kodular/themysteryman8308/MagicLiker/nointernet.yail", 462923);
        new FString("com.google.appinventor.components.runtime.Network");
        Lit72 = fString;
        new SimpleSymbol("Network1");
        Lit71 = (SimpleSymbol) simpleSymbol18.readResolve();
        new FString("com.google.appinventor.components.runtime.Network");
        Lit70 = fString2;
        ...
        Lit67 = (SimpleSymbol) simpleSymbol19.readResolve();
        new SimpleSymbol("Label3$Click");
        Lit66 = (SimpleSymbol) simpleSymbol20.readResolve();
        ...
        Lit63 = (SimpleSymbol) simpleSymbol23.readResolve();
        ...
        Lit60 = (SimpleSymbol) simpleSymbol24.readResolve();
        ...
        Lit54 = (SimpleSymbol) simpleSymbol26.readResolve();
        new FString("com.google.appinventor.components.runtime.SpaceView");
        Lit53 = fString8;
        new FString("com.google.appinventor.components.runtime.Label");
        Lit52 = fString9;
        new SimpleSymbol("TextAlignment");
        Lit50 = (SimpleSymbol) simpleSymbol27.readResolve();
        new SimpleSymbol("FontItalic");
        Lit49 = (SimpleSymbol) simpleSymbol28.readResolve();
        ...
        Lit41 = (SimpleSymbol) simpleSymbol31.readResolve();
        new SimpleSymbol("FontSize");
        Lit39 = (SimpleSymbol) simpleSymbol32.readResolve();
        new SimpleSymbol("FontBold");
        Lit38 = (SimpleSymbol) simpleSymbol33.readResolve();
        ...
        Lit33 = (SimpleSymbol) simpleSymbol35.readResolve();
        new FString("com.google.appinventor.components.runtime.SpaceView");
        Lit32 = fString16;
        new FString("com.google.appinventor.components.runtime.KodularLottie");
        Lit31 = fString17;
        new SimpleSymbol("Source");
        Lit30 = (SimpleSymbol) simpleSymbol36.readResolve();
        new SimpleSymbol("Width");
        Lit28 = (SimpleSymbol) simpleSymbol37.readResolve();
        ...
        new SimpleSymbol("nointernet$BackPressed");
        ...
        Lit18 = (SimpleSymbol) simpleSymbol45.readResolve();
        ...
        Lit8 = (SimpleSymbol) simpleSymbol52.readResolve();
        new SimpleSymbol("AlignVertical");
        Lit6 = (SimpleSymbol) simpleSymbol53.readResolve();
        new SimpleSymbol("number");
        Lit5 = (SimpleSymbol) simpleSymbol54.readResolve();
        ...
        new SimpleSymbol("nointernet");
        Lit0 = (SimpleSymbol) simpleSymbol58.readResolve();
    }
    ...
    public nointernet() {
        ...
        frame3.$main = this;
        frame frame4 = frame3;
        new ModuleMethod(frame4, 1, Lit76, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.get$Mnsimple$Mnname = moduleMethod36;
        new ModuleMethod(frame4, 2, Lit77, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = moduleMethod2;
        new ModuleMethod(frame4, 3, Lit78, 8194);
        this.add$Mnto$Mnform$Mnenvironment = moduleMethod3;
        new ModuleMethod(frame4, 4, Lit79, 8193);
        this.lookup$Mnin$Mnform$Mnenvironment = moduleMethod4;
        new ModuleMethod(frame4, 6, Lit80, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = moduleMethod5;
        new ModuleMethod(frame4, 7, Lit81, 8194);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = moduleMethod6;
        new ModuleMethod(frame4, 8, Lit82, 8194);
        this.add$Mnto$Mnevents = moduleMethod7;
        new ModuleMethod(frame4, 9, Lit83, 16388);
        this.add$Mnto$Mncomponents = moduleMethod8;
        new ModuleMethod(frame4, 10, Lit84, 8194);
        this.add$Mnto$Mnglobal$Mnvars = moduleMethod9;
        new ModuleMethod(frame4, 11, Lit85, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = moduleMethod10;
        new ModuleMethod(frame4, 12, Lit86, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        new ModuleMethod(frame4, 14, Lit87, 16388);
        this.dispatchEvent = moduleMethod13;
        new ModuleMethod(frame4, 15, Lit88, 16388);
        this.dispatchGenericEvent = moduleMethod14;
        new ModuleMethod(frame4, 16, Lit89, 8194);
        this.lookup$Mnhandler = moduleMethod15;
        new ModuleMethod(frame4, 17, (Object) null, 0);
        ModuleMethod moduleMethod37 = moduleMethod16;
        moduleMethod37.setProperty("source-location", "/tmp/runtime947713386790088419.scm:615");
        ...
        new ModuleMethod(frame4, 20, Lit21, 0);
        this.nointernet$BackPressed = moduleMethod19;
        ...
        new ModuleMethod(frame4, 35, Lit66, 0);
        this.Label3$Click = moduleMethod34;
        new ModuleMethod(frame4, 36, Lit74, 0);
        this.Network1$OnConnect = moduleMethod35;
    }
    ...
    public final void run(CallContext $ctx) {
        ...
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            Object andCoerceProperty$Ex4 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit10, "IndianSmartSMMPanel", Lit9);
            Object andCoerceProperty$Ex5 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit11, Boolean.TRUE, Lit12);
            Object andCoerceProperty$Ex6 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit13, Lit14, Lit5);
            Object andCoerceProperty$Ex7 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit15, Lit16, Lit5);
            Object andCoerceProperty$Ex8 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit17, Boolean.TRUE, Lit12);
            Object andCoerceProperty$Ex9 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit18, "none", Lit9);
            Object andCoerceProperty$Ex10 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit19, Boolean.FALSE, Lit12);
            Values.writeValues(C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit20, "Oh No!", Lit9), $result);
        } else {
            new Promise(lambda$Fn2);
            addToFormDoAfterCreation(obj2);
        }
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Object addToCurrentFormEnvironment = C1223runtime.addToCurrentFormEnvironment(Lit21, this.nointernet$BackPressed);
        } else {
            addToFormEnvironment(Lit21, this.nointernet$BackPressed);
        }
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) C1223runtime.$Stthis$Mnform$St, "nointernet", "BackPressed");
        } else {
            addToEvents(Lit0, Lit22);
        }
        this.Lottie1 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit23, Lit24, lambda$Fn3), $result);
        } else {
            addToComponents(Lit0, Lit31, Lit24, lambda$Fn4);
        }
        this.Space1 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit32, Lit33, lambda$Fn5), $result);
        } else {
            addToComponents(Lit0, Lit35, Lit33, lambda$Fn6);
        }
        this.Label1 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit36, Lit37, lambda$Fn7), $result);
        } else {
            addToComponents(Lit0, Lit42, Lit37, lambda$Fn8);
        }
        this.Horizontal_Arrangement1 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit43, Lit44, lambda$Fn9), $result);
        } else {
            addToComponents(Lit0, Lit46, Lit44, lambda$Fn10);
        }
        this.Label2 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit44, Lit47, Lit48, lambda$Fn11), $result);
        } else {
            addToComponents(Lit44, Lit52, Lit48, lambda$Fn12);
        }
        this.Space2 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit53, Lit54, lambda$Fn13), $result);
        } else {
            addToComponents(Lit0, Lit56, Lit54, lambda$Fn14);
        }
        this.Label3 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit57, Lit58, lambda$Fn15), $result);
        } else {
            addToComponents(Lit0, Lit62, Lit58, lambda$Fn16);
        }
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Object addToCurrentFormEnvironment2 = C1223runtime.addToCurrentFormEnvironment(Lit66, this.Label3$Click);
        } else {
            addToFormEnvironment(Lit66, this.Label3$Click);
        }
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) C1223runtime.$Stthis$Mnform$St, "Label3", "Click");
        } else {
            addToEvents(Lit58, Lit67);
        }
        this.Activity_Starter1 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit68, Lit63, Boolean.FALSE), $result);
        } else {
            addToComponents(Lit0, Lit69, Lit63, Boolean.FALSE);
        }
        this.Network1 = null;
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(C1223runtime.addComponentWithinRepl(Lit0, Lit70, Lit71, Boolean.FALSE), $result);
        } else {
            addToComponents(Lit0, Lit72, Lit71, Boolean.FALSE);
        }
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Object addToCurrentFormEnvironment3 = C1223runtime.addToCurrentFormEnvironment(Lit74, this.Network1$OnConnect);
        } else {
            addToFormEnvironment(Lit74, this.Network1$OnConnect);
        }
        if (C1223runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) C1223runtime.$Stthis$Mnform$St, "Network1", "OnConnect");
        } else {
            addToEvents(Lit71, Lit75);
        }
    ...
    static Object lambda3() {
        ...
        Object andCoerceProperty$Ex9 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit18, "none", Lit9);
        Object andCoerceProperty$Ex10 = C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit19, Boolean.FALSE, Lit12);
        return C1223runtime.setAndCoerceProperty$Ex(Lit0, Lit20, "Oh No!", Lit9);
    }

    public Object nointernet$BackPressed() {
        C1223runtime.setThisForm();
        return C1223runtime.callYailPrimitive(C1223runtime.close$Mnapplication, LList.Empty, LList.Empty, "close application");
    }

    static Object lambda4() {
        Object andCoerceProperty$Ex = C1223runtime.setAndCoerceProperty$Ex(Lit24, Lit25, Boolean.FALSE, Lit12);
        Object andCoerceProperty$Ex2 = C1223runtime.setAndCoerceProperty$Ex(Lit24, Lit26, Lit27, Lit5);
        Object andCoerceProperty$Ex3 = C1223runtime.setAndCoerceProperty$Ex(Lit24, Lit28, Lit29, Lit5);
        return C1223runtime.setAndCoerceProperty$Ex(Lit24, Lit30, "3648-no-internet-connection.json", Lit9);
    }
    ...
    static Object lambda6() {
        return C1223runtime.setAndCoerceProperty$Ex(Lit33, Lit26, Lit34, Lit5);
    }
    ...
    static Object lambda8() {
        Object andCoerceProperty$Ex = C1223runtime.setAndCoerceProperty$Ex(Lit37, Lit38, Boolean.TRUE, Lit12);
        Object andCoerceProperty$Ex2 = C1223runtime.setAndCoerceProperty$Ex(Lit37, Lit39, Lit40, Lit5);
        return C1223runtime.setAndCoerceProperty$Ex(Lit37, Lit41, "No Connectivity", Lit9);
    }
    ...
    static Object lambda10() {
        Object andCoerceProperty$Ex = C1223runtime.setAndCoerceProperty$Ex(Lit44, Lit3, Lit4, Lit5);
        Object andCoerceProperty$Ex2 = C1223runtime.setAndCoerceProperty$Ex(Lit44, Lit6, Lit7, Lit5);
        return C1223runtime.setAndCoerceProperty$Ex(Lit44, Lit28, Lit45, Lit5);
    }
    ...
    static Object lambda12() {
        Object andCoerceProperty$Ex = C1223runtime.setAndCoerceProperty$Ex(Lit48, Lit49, Boolean.TRUE, Lit12);
        Object andCoerceProperty$Ex2 = C1223runtime.setAndCoerceProperty$Ex(Lit48, Lit41, "It seems like there is no data connection available on your device. Check your Data connection! ", Lit9);
        return C1223runtime.setAndCoerceProperty$Ex(Lit48, Lit50, Lit51, Lit5);
    }
    ...
    static Object lambda14() {
        return C1223runtime.setAndCoerceProperty$Ex(Lit54, Lit26, Lit55, Lit5);
    }
    ...
    static Object lambda16() {
        Object andCoerceProperty$Ex = C1223runtime.setAndCoerceProperty$Ex(Lit58, Lit25, Boolean.TRUE, Lit12);
        Object andCoerceProperty$Ex2 = C1223runtime.setAndCoerceProperty$Ex(Lit58, Lit38, Boolean.TRUE, Lit12);
        Object andCoerceProperty$Ex3 = C1223runtime.setAndCoerceProperty$Ex(Lit58, Lit39, Lit59, Lit5);
        Object andCoerceProperty$Ex4 = C1223runtime.setAndCoerceProperty$Ex(Lit58, Lit41, "TRY AGAIN", Lit9);
        return C1223runtime.setAndCoerceProperty$Ex(Lit58, Lit60, Lit61, Lit5);
    }
    ...
    public Object Label3$Click() {
        C1223runtime.setThisForm();
        Object andCoerceProperty$Ex = C1223runtime.setAndCoerceProperty$Ex(Lit63, Lit64, "android.settings.SETTINGS", Lit9);
        return C1223runtime.callComponentMethod(Lit63, Lit65, LList.Empty, LList.Empty);
    }

    public Object Network1$OnConnect() {
        C1223runtime.setThisForm();
        return C1223runtime.callYailPrimitive(C1223runtime.open$Mnanother$Mnscreen, LList.list1("main"), Lit73, "open another screen");
    }

    /* renamed from: io.kodular.themysteryman8308.MagicLiker.nointernet$frame */
    /* compiled from: nointernet.yail */
    public class frame extends ModuleBody {
        ...
        public int match4(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3, Object obj4, CallContext callContext) {
            ...
            switch (moduleMethod2.selector) {
                ...
                case 15:
                    ...
                    Object obj17 = obj5;
                    Object obj18 = obj17;
                    if (!(obj17 instanceof nointernet)) {
                        return -786431;
                    }
        ...
        public Object apply0(ModuleMethod moduleMethod) {
            ...
            switch (moduleMethod2.selector) {
                case 17:
                    return nointernet.lambda2();
                case 18:
                    this.$main.$define();
                    return Values.empty;
                case 19:
                    return nointernet.lambda3();
                case 20:
                    return this.$main.nointernet$BackPressed();
                case 21:
                    return nointernet.lambda4();
                case 22:
                    return nointernet.lambda5();
                case 23:
                    return nointernet.lambda6();
                case 24:
                    return nointernet.lambda7();
                case 25:
                    return nointernet.lambda8();
                case 26:
                    return nointernet.lambda9();
                case 27:
                    return nointernet.lambda10();
                case 28:
                    return nointernet.lambda11();
                case 29:
                    return nointernet.lambda12();
                case 30:
                    return nointernet.lambda13();
                case 31:
                    return nointernet.lambda14();
                case 32:
                    return nointernet.lambda15();
                case 33:
                    return nointernet.lambda16();
                case 34:
                    return nointernet.lambda17();
                case 35:
                    return this.$main.Label3$Click();
                case 36:
                    return this.$main.Network1$OnConnect();
                default:
